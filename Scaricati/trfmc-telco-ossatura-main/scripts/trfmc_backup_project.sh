...
OUT="$PARENT/trfmc_full_project_backup_v30_${TS}.tar.gz"
MANIFEST="$PARENT/trfmc_full_project_backup_v30_${TS}_manifest.txt"

echo "============================================================"
echo "TRFMC FULL PROJECT BACKUP v0.30"
echo "Root: $ROOT"
echo "Output: $OUT"
echo "============================================================"
