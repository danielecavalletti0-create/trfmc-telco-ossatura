...

{
  ...
  sudo docker rm -f trfmc_frontend_v30 trfmc_backend_v30 trfmc_frontend_v29 trfmc_backend_v29 \
    ...
    trfmc_backend_v20 \
    trfmc_backend_v21 \
    trfmc_backend_v22 trfmc_backend_v23 \
    trfmc_frontend_v05 \
    trfmc_frontend_v06 \
    trfmc_frontend_v07 \
    trfmc_frontend_v08 \
    ...
    trfmc_frontend_v20 \
    trfmc_frontend_v21 \
    trfmc_frontend_v22 trfmc_frontend_v23 \
    trfmc_backend_v24 trfmc_frontend_v24 trfmc_backend_v28 trfmc_frontend_v28 2>/dev/null || true
