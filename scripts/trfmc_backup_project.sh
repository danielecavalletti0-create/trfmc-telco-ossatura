...
OUT="$PARENT/trfmc_full_project_backup_v21_${TS}.tar.gz"
MANIFEST="$PARENT/trfmc_full_project_backup_v21_${TS}_manifest.txt"

echo "============================================================"
echo "TRFMC FULL PROJECT BACKUP v0.21"
echo "Root: $ROOT"
echo "Output: $OUT"
echo "============================================================"
